...
<div class="content-wrapper" style="background-color: #0d1117;border-left:1px solid #fff;border-top:1px solid #fff;">
  ...
  <section class="content-header" style="background-color: #0d1117;color: #fff;">
    ...
    <ol class="breadcrumb" style="background-color: #0d1117;color: #fff;">
      ...
      <li class="active" style="background-color: #0d1117;color: #fff;">Gestor Slider</li>
    </ol>
  </section>
          ...
          <input type="text" indice="'.$key.'" value="" class="slider form-control anchoTexto anchoTexto'.$key.'" data-slider-min="0" 
            ...
            <!-- ==========================  Visualizar Slider ========================== -->
              ...
              <div class="slide">
                  ...
                  <img class="imgProducto1" src="' . $value["imgFondo"] . '">
  
                  <div class="slideOpciones ' . $value["tipoSlide"] . '">


              <img class="imgProducto" src="' . $value["imgProducto"] . '"

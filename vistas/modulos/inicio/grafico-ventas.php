...
======================================-->
<!-- solid sales graph -->
<div class="box box-solid bg-teal-gradient" style="color: #000000;">
	...
	<div class="box-header" style="color: #000000;">
		...
		<h3 class="box-title" style="color: #000000;">Gráfico de Ventas</h3>
	...
	<div class="box-body border-radius-none">
		...
		<div class="chart" id="line-chart" style="height: 250px;color:#000000;"></div>
	...
	<div class="box-footer no-border">
		...
		<div class="row">
			...
			<div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4;color:#000000;">
				...
				<div class="knob-label" style="color: #000000;">Paypal</div>
			...
			<div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4;color:#000000;">
				...
				<div class="knob-label" style="color: #000;">Payu</div>
